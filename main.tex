...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]\caption{\label{fig:tesla}{Figura1.jpg}Representación gráfica de un HMM.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]\caption{\label{fig:Figura2}{Figura2.jpg}Representación gráfica de un HMM.}
\end{figure}
